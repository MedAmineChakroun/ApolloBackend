...
namespace ApolloBackend.Migrations
{
    ...
    [Migration("20250428222847_fix id for all entityies in local")]
    partial class fixidforallentityiesinlocal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApolloBackend.Models.Article", b =>
                {
                    ...
                    b.Property<DateTime>("ArtDateCreate")
            ...
            modelBuilder.Entity("ApolloBackend.Models.Client", b =>
                {
                    ...
                    b.Property<DateTime?>("TiersDateCreate")
                        .HasColumnType("datetime2");

                    b.Property<string>("TiersEmail")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("TiersFlag")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApolloBackend.Models.DocumentVente", b =>
                {
                    ...
                    b.Property<int?>("DocEtat")
                        .HasColumnType("int");

                    b.Property<int?>("DocFlag")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApolloBackend.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApolloBackend.Models.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApolloBackend.Models.WishlistItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApolloBackend.Models.Rating", b =>
                {
                    b.HasOne("ApolloBackend.Models.Article", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("ApolloBackend.Models.WishlistItem", b =>
                {
                    b.HasOne("ApolloBackend.Models.Article", "Article")
                        .WithMany()
                        .HasForeignKey("ArtId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
